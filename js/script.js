...
function switchMode() {
    ...
    var texts = document.querySelectorAll("p, span, h2, nav");
    if (body.classList.contains("night-mode")) {
        body.classList.remove("night-mode");
        body.classList.add("light-mode");
      for (var i = 0; i < texts.length; i++) {
        texts[i].classList.remove("night-mode");
        texts[i].classList.add("light-mode");
      }
    } else {
        body.classList.remove("light-mode");
      body.classList.add("night-mode");
      for (var i = 0; i < texts.length; i++) {
        texts[i].classList.remove("light-mode");
        texts[i].classList.add("night-mode");
      }
    }
    var nightMode = Boolean(localStorage.getItem("night-mode"));
